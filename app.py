...
# System Limitations
    ...
    st.markdown("""
        <div style='font-size: 0.85rem; line-height: 1.6; color: #d4d4d8;'>
            <span style='color: #f43f5e;'>■</span> <b>Manual Metadata Input:</b> The system currently requires the exact Cricsheet Match ID as a manual parameter. If the automated fetch fails, users must manually download and provide the relevant JSON file from Cricsheet.<br><br>
